...
var gbox={
	...
	_canlog:false,
	_splash:{
		gaugeLittleColor:null,
		gaugeLittleBackColor:null,
		gaugeBorderColor:null,
		gaugeBackColor:null,
		gaugeColor:"rgb(205,38,38)",
		gaugeHeight:10,
		background:null,
		minimalTime:0,
		footnotes:null,
  ...
  */	
	initScreen:function(w,h) {
		...
		gbox._screen.ontouchstart=function(evt) { gbox._screenposition=gbox._domgetabsposition(gbox._screen);evt.preventDefault();evt.stopPropagation();};
		...
		gbox._screen.onmousedown=function(evt) {gbox._screenposition=gbox._domgetabsposition(gbox._screen);evt.preventDefault();evt.stopPropagation();};
